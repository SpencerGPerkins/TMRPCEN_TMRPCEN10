...
Main Script : Logarithmic Compression Approach
...
# Optimizer
params = list(model_cnn.parameters())
...
for e in range(0, epochs):
    ...
    if epoch_acc > best_acc:
        ...
        cf_df.to_csv('../../results/'+exper+'/confusion_mat/logmel/cf_'+val_fold+'.csv')
...
results_df.to_csv(
'../../results/'+exper+'/'+save_path+'logmel_'+val_fold+'.csv')
torch.save(

best_cnn_wts, '../../results/'+exper+'/weights/logmel/best_cnn_wts_'+val_fold+'.pt')
